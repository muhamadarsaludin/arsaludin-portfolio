...
><strong className="text-primary font-semibold">"Nanti aja lah pas weekend atau sehabis sprint."</strong>

Tapi begitu weekend tiba atau ada waktu luang, saya malah berpikir:

><strong className="text-primary font-semibold italic">"Masa iya di kantor sudah seminggu penuh ngoding, sekarang weekend pun masih harus ngoding?"</strong> 
...
><strong className="text-primary font-semibold italic">"Duh, desainnya harus kayak gimana ya biar kelihatan keren?" <br/> "Tech stack-nya pakai apa aja ya yang bagus? <br/> “Bikin yang simple static aja atau sekalian yang dinamis pakai database ya?” <br/> "Isinya apa aja biar kelihatan profesional?"</strong>
