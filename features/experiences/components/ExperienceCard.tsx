...
export const ExperienceCard = ({
  ...
  const handleNext = useCallback(() => {
    if (selectedIndex !== null && experience.images) {
      setZoomScale(1)
      setSelectedIndex((selectedIndex + 1) % experience.images.length)
    }
  }, [selectedIndex, experience.images])

  const handlePrev = useCallback(() => {
    if (selectedIndex !== null && experience.images) {
      setZoomScale(1)
      setSelectedIndex(
        (selectedIndex - 1 + experience.images.length) % experience.images.length
      )
    }
  }, [selectedIndex, experience.images])
  ...
  const currentImage = selectedIndex !== null ? experience.images?.[selectedIndex] : null
