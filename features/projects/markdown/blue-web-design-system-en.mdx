...
This project was driven by the momentum of **Blibli's rebranding** on October 5, 2023, which brought many changes, as well as a comprehensive transformation of the company's visual identity and digital ecosystem. This change also encouraged the need for an update to the **BLUE Web Design System** to align with the rebranding and the spirit of Blibli's new identity.
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/blue-web-design-system/design-tokens.webp", alt: "Converting design tokens from JSON format to SCSS using Style Dictionary"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Converting design tokens from JSON format to SCSS using Style Dictionary</p>
  </div>
</div>
