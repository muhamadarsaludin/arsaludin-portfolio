...
* <strong className="text-primary font-semibold">The mobile design system lagged behind the web</strong> because it did not yet have focused management.
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/blue-android-design-system/blue-icon-usage-2.webp", alt: "BLUE icon implementation in Android project"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">BLUE icon implementation in Android project</p>
  </div>
</div>
