...
<div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
  <div className="w-full">
    <MiracleImagePreview 
      images={[{image_url: "/projects/personal-portfolio-website/reaching-out.webp", alt: "Process of reaching out to colleagues to request supporting portfolio materials"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm text-center text-secondary">Process of reaching out to colleagues to request supporting portfolio materials</p>
  </div>
  <div className="w-full">
    <MiracleImagePreview 
      images={[{image_url: "/projects/personal-portfolio-website/material.webp", alt: "Re-collecting supporting portfolio materials"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Re-collecting supporting portfolio materials</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-8/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/personal-portfolio-website/sitemap.webp", alt: "Sitemap of the portfolio website page structure"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Sitemap of the portfolio website page structure</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/personal-portfolio-website/database-schema.webp", alt: "Diagram of database schema and relationships between tables"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Diagram of database schema and relationships between tables</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/personal-portfolio-website/HLA.webp", alt: "High-level architecture diagram of the portfolio website"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">High-level architecture diagram of the portfolio website</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/personal-portfolio-website/roadmap.webp", alt: "Portfolio website roadmap page"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Portfolio website roadmap page</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/personal-portfolio-website/home.webp", alt: "Portfolio website home page"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Portfolio website home page</p>
  </div>
</div>
