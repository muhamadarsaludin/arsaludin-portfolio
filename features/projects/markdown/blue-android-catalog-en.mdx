...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/blue-android-catalog/android-catalog-design.webp", alt: "BLUE Android Catalog Application Design"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm text-center text-secondary">BLUE Android Catalog Application Design</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-3/12">
    ...
    />
    <p className="mt-3 text-sm text-center text-secondary">BLUE Android Catalog Application Preview</p>
  </div>
</div>
