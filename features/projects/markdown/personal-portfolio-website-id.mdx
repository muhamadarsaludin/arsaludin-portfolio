...
* Merancang skema database dan relasi antar tabel untuk mendukung pengelolaan konten serta fitur interaktif. Detail skema database dapat dilihat melalui diagram di [sini](https://dbdiagram.io/d/arsaludin-portfolio-6a157a42dfb20dafcdf5798b).
<div className="w-full flex items-center justify-center mt-4">
