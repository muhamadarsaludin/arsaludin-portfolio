...
<div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
  <div className="w-full">
    <MiracleImagePreview 
      images={[{image_url: "/projects/personal-portfolio-website/reaching-out.webp", alt: "Proses menghubungi kolega untuk meminta materi pendukung portofolio"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Proses menghubungi kolega untuk meminta materi pendukung portofolio</p>
  </div>
  <div className="w-full">
    <MiracleImagePreview 
      images={[{image_url: "/projects/personal-portfolio-website/material.webp", alt: "Pengumpulan kembali materi pendukung portofolio"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Pengumpulan kembali materi pendukung portofolio</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-8/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/personal-portfolio-website/sitemap.webp", alt: "Sitemap struktur halaman website portofolio"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Sitemap struktur halaman website portofolio</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/personal-portfolio-website/database-schema.webp", alt: "Diagram skema database dan relasi antar tabel"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Diagram skema database dan relasi antar tabel</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/personal-portfolio-website/HLA.webp", alt: "Diagram high-level architecture website portofolio"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Diagram high-level architecture website portofolio</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/personal-portfolio-website/roadmap.webp", alt: "Halaman roadmap website portofolio"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Halaman roadmap website portofolio</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/personal-portfolio-website/home.webp", alt: "Halaman beranda website portofolio"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Halaman beranda website portofolio</p>
  </div>
</div>
