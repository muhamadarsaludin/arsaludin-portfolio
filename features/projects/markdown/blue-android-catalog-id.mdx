...
Berdasarkan kondisi tersebut, terdapat beberapa permasalahan utama dalam proses adopsi BLUE Android Design System di antaranya:
...
Dalam project ini, saya berperan sebagai UX Engineer sekaligus PIC (Person in Charge) yang bertanggung jawab atas pengembangan BLUE Android Catalog sebagai media eksplorasi design system.
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/blue-android-catalog/android-catalog-design.webp", alt: "Desain Aplikasi BLUE Android Catalog"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Desain Aplikasi BLUE Android Catalog</p>
  </div>
</div>

* Mengembangkan seluruh halaman pada aplikasi BLUE Android Catalog, termasuk halaman komponen dan detail komponen untuk menampilkan daftar komponen, contoh penggunaan, dan *complex interaction cases* pada UI elements.
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-3/12">
    ...
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Pratinjau Aplikasi BLUE Android Catalog</p>
  </div>
</div>
