...
<div className="flex flex-col items-center">
  ...
  <small className="text-secondary mt-3 w-full text-center text-sm italic">
...
<div className="mt-4 grid w-full grid-cols-1 gap-6 md:grid-cols-2">
  <div className="w-full">
    <MiracleImagePreview
      ...
      sizes="(max-width: 768px) 100vw, 750px"
    />
    <p className="text-secondary mt-3 text-center text-sm italic">Struktur BLUE design tokens</p>
  </div>
  <div className="w-full">
    <MiracleImagePreview
      images={[
