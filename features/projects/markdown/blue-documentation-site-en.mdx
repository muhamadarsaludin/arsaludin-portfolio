...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    ...
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Animation example on the BLUE Documentation Site</p>
  </div>
</div>
...
<div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
  <div className="w-full">
    <MiracleImagePreview 
      images={[{image_url: "/projects/blue-documentation-site/light.webp", alt: "Light mode appearance on the BLUE Documentation Site"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Light mode appearance on the BLUE Documentation Site</p>
  </div>
  <div className="w-full">
    <MiracleImagePreview 
      images={[{image_url: "/projects/blue-documentation-site/dark.webp", alt: "Dark mode appearance on the BLUE Documentation Site"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Dark mode appearance on the BLUE Documentation Site</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/blue-documentation-site/hybrid-content-access.webp", alt: "Page appearance with restricted content in public access mode"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Page appearance with restricted content in public access mode</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/blue-documentation-site/auth.webp", alt: "Login page with Microsoft Account to access the BLUE Documentation Site CMS"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Login page with Microsoft Account to access the BLUE Documentation Site CMS</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/blue-documentation-site/cms.webp", alt: "Edit mode appearance on the BLUE Documentation Site CMS"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Edit mode appearance on the BLUE Documentation Site CMS</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/blue-documentation-site/home.webp", alt: "BLUE Documentation Site main page appearance"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">BLUE Documentation Site main page appearance</p>
  </div>
</div>
