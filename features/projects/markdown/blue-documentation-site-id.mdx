...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    ...
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Contoh animasi pada BLUE Documentation Site</p>
  </div>
</div>
...
<div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
  <div className="w-full">
    <MiracleImagePreview 
      images={[{image_url: "/projects/blue-documentation-site/light.webp", alt: "Tampilan light mode pada BLUE Documentation Site"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Tampilan light mode pada BLUE Documentation Site</p>
  </div>
  <div className="w-full">
    <MiracleImagePreview 
      images={[{image_url: "/projects/blue-documentation-site/dark.webp", alt: "Tampilan dark mode pada BLUE Documentation Site"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Tampilan dark mode pada BLUE Documentation Site</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/blue-documentation-site/hybrid-content-access.webp", alt: "Tampilan halaman dengan konten yang dibatasi pada mode akses publik"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Tampilan halaman dengan konten yang dibatasi pada mode akses publik</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/blue-documentation-site/auth.webp", alt: "Halaman login dengan Microsoft Account untuk mengakses CMS BLUE Documentation Site"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Halaman login dengan Microsoft Account untuk mengakses CMS BLUE Documentation Site</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/blue-documentation-site/cms.webp", alt: "Tampilan mode edit pada CMS BLUE Documentation Site"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Tampilan mode edit pada CMS BLUE Documentation Site</p>
  </div>
</div>
...
<div className="w-full flex items-center justify-center mt-4">
  <div className="w-full md:w-6/12">
    <MiracleImagePreview 
      images={[{image_url: "/projects/blue-documentation-site/home.webp", alt: "Tampilan halaman utama BLUE Documentation Site"}]}
      sizes = "(max-width: 768px) 100vw, 750px"
    />
    <p className="mt-3 text-sm italic text-center text-secondary">Tampilan halaman utama BLUE Documentation Site</p>
  </div>
</div>
