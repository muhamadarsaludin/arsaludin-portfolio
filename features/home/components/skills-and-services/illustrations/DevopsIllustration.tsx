  ...
  return (
    <BrowserIllustration>
      <div className="w-full h-full relative flex justify-center items-center">
        ...
        >
          <div className="h-2.5 w-2.5 -mt-[5px] rounded-full bg-blue-400 shadow-[0_0_8px_rgba(59,130,246,0.8)] dark:bg-blue-500" />
        </motion.div>
        ...
        <div className="absolute inset-0 z-10 flex items-center justify-center">
          ...
          {/* Top: Code */}
          <div className="absolute -translate-y-[48px] flex h-7 w-7 items-center justify-center rounded border border-primary bg-white shadow-sm dark:bg-neutral-900">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="h-3.5 w-3.5 text-red-400 dark:text-red-500">
          ...
          <div className="absolute translate-x-[48px] flex h-7 w-7 items-center justify-center rounded border border-primary bg-white shadow-sm dark:bg-neutral-900">
            <motion.div
          ...
          <div className="absolute translate-y-[48px] flex h-7 w-7 flex-col items-center justify-center gap-[3px] rounded border border-primary bg-white shadow-sm dark:bg-neutral-900">
            <div className="h-1.5 w-4 rounded-[1px] border border-blue-400 dark:border-blue-500" />
            <div className="h-1.5 w-4 rounded-[1px] border border-blue-400 dark:border-blue-500" />
          </div>

          {/* Left: Monitor (Chart) */}
          <div className="absolute -translate-x-[48px] flex h-7 w-7 items-end justify-center gap-[2px] rounded border border-primary bg-white p-[5px] shadow-sm dark:bg-neutral-900">
        ...
        <motion.div 
          className="relative z-20 flex h-10 w-10 items-center justify-center rounded-xl border border-primary shadow-md bg-neutral-300 dark:bg-neutral-700"
