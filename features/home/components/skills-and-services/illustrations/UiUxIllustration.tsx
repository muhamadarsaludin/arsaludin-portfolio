      ...
      <div className="relative flex h-full w-full">
        ...
        <div className="absolute inset-0 z-0 grid grid-cols-4 gap-1 p-2 opacity-20 dark:opacity-30">
          {[...Array(12)].map((_, i) => (
            <div
              key={i}
              className="border border-dashed border-neutral-500 dark:border-neutral-400"
            />
          ))}
        </div>
        ...
        <div className="relative z-1 flex flex-1 overflow-hidden">
          {/* Left Panel: Layers */}
          <div className="border-primary bg-surface-secondary flex w-15 border-r">
            ...
            <div className="flex flex-1 flex-col gap-1 p-1">
              ...
              <div className="flex flex-col gap-1 pb-1">
                ...
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="h-0.5 w-full rounded bg-neutral-300 dark:bg-neutral-700"
                  />
                ))}
              </div>
            </div>
          ...
          <div className="flex flex-1 items-center justify-center">
            <motion.div
              className="relative flex h-16 flex-col gap-1 border border-blue-400 bg-white p-1 shadow-sm dark:border-blue-500 dark:bg-neutral-800"
              animate={{ width: ["64px", "64px", "64px", "84px", "64px", "64px"] }}
              transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
            >
              {/* Selection Handles */}
              <div className="absolute -top-1 -left-1 h-1.5 w-1.5 border border-blue-400 bg-white dark:border-blue-500" />
              <div className="absolute -top-1 -right-1 h-1.5 w-1.5 border border-blue-400 bg-white dark:border-blue-500" />
              <div className="absolute -bottom-1 -left-1 h-1.5 w-1.5 border border-blue-400 bg-white dark:border-blue-500" />
              <div className="absolute -right-1 -bottom-1 h-1.5 w-1.5 border border-blue-400 bg-white dark:border-blue-500" />
          ...
          <div className="border-primary bg-surface-secondary flex w-16 shrink-0 flex-col gap-1 border-l p-1">
            <div className="border-primary flex justify-between gap-1 border-b pb-1">
              <div className="h-2 w-2 shrink-0 rounded bg-neutral-400 dark:bg-neutral-600" />
            ...
            <div className="flex items-center gap-1 rounded border border-neutral-300 bg-white p-0.5 shadow-sm dark:border-neutral-600 dark:bg-neutral-800">
              ...
              <span className="font-mono text-[6px] tracking-tighter text-neutral-700 dark:text-neutral-300">
                #171717
              </span>
            </div>
            <motion.div
