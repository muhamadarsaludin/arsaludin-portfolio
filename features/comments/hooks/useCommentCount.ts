 ...
 * @param initialCount - Optional server-side or cached count for immediate display.
 * @param enabled - Controls whether the query should execute.
 * @returns The TanStack Query result containing the total count.
 * @example
