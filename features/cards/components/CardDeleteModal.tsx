  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6 py-2">
        <p className="text-secondary text-sm leading-relaxed">{t("modal.delete.description")}</p>

        {/* Card Data Shadow Preview */}
        <div className="rounded-xl border border-dashed border-red-500/30 bg-red-500/5 p-4">
          <h4 className="text-primary mb-1 line-clamp-1 font-semibold">{card.title}</h4>
          <div className="text-secondary line-clamp-2 text-xs">{card.description}</div>
        </div>
