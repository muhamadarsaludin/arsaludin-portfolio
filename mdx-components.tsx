...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    // 1. Headings
    Heading,
    h1: (props) => <Heading level={1} className="font-semibold" {...props} />,
    h2: (props) => <Heading level={2} className="font-semibold" {...props} />,
    h3: (props) => <Heading level={3} className="font-semibold" {...props} />,
    h4: (props) => <Heading level={4} className="font-semibold" {...props} />,
    ...
    th: (props) => <th className="border-b border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900 px-4 py-3 font-semibold text-left" {...props} />,
    td: (props) => <td className="border-b border-neutral-200 dark:border-neutral-800 px-4 py-3" {...props} />,
